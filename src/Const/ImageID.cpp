...
const std::unordered_map<ImageID, std::string> FilePathList = {
    ...
    {ImageID::game_item, "image/game/item.png"},
    {ImageID::game_chara_marisa, "image/game/chara/marisa/player.png"},
    {ImageID::game_chara_reimu, "image/game/chara/reimu/player.png"},
    {ImageID::game_chara_satsuki, "image/game/chara/satsuki/player.png"},
    {ImageID::game_chara_test, "image/game/chara/test/player.png"},
